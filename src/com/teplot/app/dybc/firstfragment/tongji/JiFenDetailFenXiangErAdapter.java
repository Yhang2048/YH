...
public class JiFenDetailFenXiangErAdapter extends BaseAdapter {
	private Context mContext;
	private List<SingInModel> mModels;
	private LayoutInflater mInflater;

	public JiFenDetailFenXiangErAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.item_jifen_er_detail, parent,
					false);
