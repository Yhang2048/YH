...
public class JiFenSiDetail extends Activity {

	private ListView mLvFenXiang;
	private JiFenDetailFenXiangSiAdapter mAdapter;
	private String url;
	private String url2;
	// 基准分值
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Boolean isNetWork = netUtil
				.isNetworkAvalible(JiFenSiDetail.this);
		if (isNetWork) {
			loadDate();
		} else {
			Toast.makeText(JiFenSiDetail.this, "网络连接不可用",
	...
	private void initView() {
		...
		mAdapter = new JiFenDetailFenXiangSiAdapter(this);
						...
						new Listener<KaoPingJiFenModel>() {
							...
							public void onResponse(KaoPingJiFenModel arg0) {
								if (arg0!=null) {
									...
									intent.putExtra("szongfen", zongfen);
									setResult(1, intent);
									
									Preferences.getPrefer(getApplicationContext()).putString("sizongfen", zongfen);
								}
							}
						}, new ErrorListener() {
