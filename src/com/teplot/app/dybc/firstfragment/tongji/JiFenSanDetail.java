...
public class JiFenSanDetail extends Activity {

	private ListView mLvFenXiang;
	private JiFenDetailFenXiangSanAdapter mAdapter;
	private String url;
	private String url2;
	// 基准分值
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Boolean isNetWork = netUtil
				.isNetworkAvalible(JiFenSanDetail.this);
		if (isNetWork) {
			loadDate();
		} else {
			Toast.makeText(JiFenSanDetail.this, "网络连接不可用",
	...
	private void initView() {
		...
		mAdapter = new JiFenDetailFenXiangSanAdapter(this);
						...
						new Listener<KaoPingJiFenModel>() {
							...
							public void onResponse(KaoPingJiFenModel arg0) {
								if (arg0!=null) {
									...
									intent.putExtra("sazongfen", zongfen);
									setResult(1, intent);
									
									Preferences.getPrefer(getApplicationContext()).putString("sanzongfen", zongfen);
								}
							}
						}, new ErrorListener() {
