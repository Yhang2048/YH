...
import com.teplot.app.dybc.firstfragment.baibaoxiang.DangZhangActivity.NewsWebClient;
...
public class LiangXueYiZuoActivity extends Activity {
	...
	private void initData() {
		String token = Preferences.getPrefer(getApplicationContext())
				.getString("token", "");
		String url = Url.BaibaoxiangDetail + "token="+ token + "&id="+13;
