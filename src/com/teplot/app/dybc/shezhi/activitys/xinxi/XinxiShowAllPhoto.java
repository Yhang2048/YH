 ...
 */
public class XinxiShowAllPhoto extends Activity {
...
//	private Button cancel;
	...
	public static ArrayList<ImageItemBean> dataList = new ArrayList<ImageItemBean>();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(Res.getLayoutID("plugin_camera_show_all_photo_xinxi"));
...
//		cancel.setOnClickListener(new CancelListener());
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(XinxiShowAllPhoto.this, GalleryXinxiActivity.class);
	...
	private class BackListener implements OnClickListener {// 返回按钮监听
		...
		public void onClick(View v) {
			intent.setClass(XinxiShowAllPhoto.this, ImageXinxiFile.class);
			startActivity(intent);
			finish();
		}
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num&&isChecked) {
							...
							Toast.makeText(XinxiShowAllPhoto.this, Res.getString("only_choose_num"), 200)
									.show();
							return;
						}
