...
import com.teplot.app.dybc.shezhi.activitys.xinxi.BitmapCache.ImageCallback;
...
public class AlbumGridViewAdapter extends BaseAdapter{
	...
	private ArrayList<ImageItemBean> selectedDataList;
	private DisplayMetrics dm;
	BitmapCache cache;
	public AlbumGridViewAdapter(Context c, ArrayList<ImageItemBean> dataList2,
			ArrayList<ImageItemBean> tempSelectBitmap) {
		mContext = c;
...
//					path, Res.getDrawableID("plugin_camera_camera_default"), 100, 100);
			final ImageItemBean item = dataList.get(position);
