 ...
 */
public class AlbumXinxiActivity extends Activity {
	//显示手机里的所有图片的列表控件
...
//	private Button cancel;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(Res.getLayoutID("plugin_camera_album_xinxi"));
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(AlbumXinxiActivity.this, GalleryXinxiActivity.class);
	...
	private class BackListener implements OnClickListener {
		public void onClick(View v) {
			intent.setClass(AlbumXinxiActivity.this, ImageXinxiFile.class);
			startActivity(intent);
			finish();
		}
	}
	...
	private void init() {
		...
		dataList = new ArrayList<ImageItemBean>();
...
//		cancel.setOnClickListener(new CancelListener());
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (Bimp.tempSelectBitmap.size() >= PublicWay.num) {
							...
							if (!removeOneData(dataList.get(position))) {
								Toast.makeText(AlbumXinxiActivity.this, Res.getString("only_choose_num"),
										200).show();
							}
							return;
						}
	...
	private boolean removeOneData(ImageItemBean imageItem) {
