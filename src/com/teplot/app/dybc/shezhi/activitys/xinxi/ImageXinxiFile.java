 ...
 */
public class ImageXinxiFile extends Activity {

	private XinxiFolderAdapter folderAdapter;
//	private Button bt_cancel;
	private Context mContext;

	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(Res.getLayoutID("plugin_camera_image_file_xinxi"));
...
//		bt_cancel.setOnClickListener(new CancelListener());
		...
		folderAdapter = new XinxiFolderAdapter(this);
