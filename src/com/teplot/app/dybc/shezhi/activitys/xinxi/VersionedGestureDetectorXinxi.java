...
public abstract class VersionedGestureDetectorXinxi {
	static final String LOG_TAG = "VersionedGestureDetector";
	OnGestureListener mListener;

	public static VersionedGestureDetectorXinxi newInstance(Context context, OnGestureListener listener) {
		final int sdkVersion = Build.VERSION.SDK_INT;
		VersionedGestureDetectorXinxi detector = null;
	...
	private static class CupcakeDetector extends VersionedGestureDetectorXinxi {
